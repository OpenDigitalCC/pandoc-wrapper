...
references its logo or cover by bare filename and stays portable. The installer
ships the bundled defaults and writes the config pointing at your external base.
